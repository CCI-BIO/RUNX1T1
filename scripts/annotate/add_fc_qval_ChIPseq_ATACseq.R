...
finalTableList <- list.files(path = "consensus_overlaps/", pattern = "_added_ChIPseq_and_ATACseq.txt", full.names = T)
finalTableListNames <- list.files(path = "consensus_overlaps/", pattern = "_added_ChIPseq_and_ATACseq.txt", full.names = F)
